"""
altered.py
This is an example module for a properly formatted Python altertype project.
It contains the ExampleClass used for altertyping Python projects.
"""
...
class ExampleClass:
    """
    ExampleClass is a class for altertyping Python projects.
