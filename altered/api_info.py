...
def display_argument_info():
    ...
    argument_details_list = [[arg_info["Name"], arg_info["Alias"], arg_info["Required"], arg_info["Type"], arg_info["Default"], arg_info["Help"]] for arg_info in argument_details]
